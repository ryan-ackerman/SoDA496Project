...
write.csv(RaceWithinModel, "BERT_base_multi_cased_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "BERT_base_multi_cased_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "BERT_base_multi_cased_Career.csv", row.names = FALSE)
```
