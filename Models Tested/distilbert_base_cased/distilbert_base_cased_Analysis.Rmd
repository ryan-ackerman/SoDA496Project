...
Race <- read.csv("distilbert_base_cased_Race.csv")
Gender <- read.csv("distilbert_base_cased_Gender.csv")
Career <- read.csv("distilbert_base_cased_Career.csv")
...
for (i in seq_along(TukeyHSD_result_list)) {
  ...
  tidy_result$Model <- "distilbert_base_cased"
