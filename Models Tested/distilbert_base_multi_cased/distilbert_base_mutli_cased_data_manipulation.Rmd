...
write.csv(RaceWithinModel, "distilbert_base_multi_cased_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "distilbert_base_multi_cased_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "distilbert_base_multi_cased_Career.csv", row.names = FALSE)
```
