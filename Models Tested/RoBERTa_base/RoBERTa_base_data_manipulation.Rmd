...
write.csv(RaceWithinModel, "RoBERTa_base_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "RoBERTa_base_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "RoBERTa_base_Career.csv", row.names = FALSE)
```
