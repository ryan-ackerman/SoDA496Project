...
Race <- read.csv("RoBERTa_base_Race.csv")
Gender <- read.csv("RoBERTa_base_Gender.csv")
Career <- read.csv("RoBERTa_base_Career.csv")
...
for (i in seq_along(TukeyHSD_result_list)) {
  ...
  tidy_result$Model <- "RoBERTa_base"
