...
write.csv(RaceWithinModel, "stsb_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "stsb_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "stsb_Career.csv", row.names = FALSE)
```
