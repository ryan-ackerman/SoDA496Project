...
write.csv(RaceWithinModel, "ERNIE_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "ERNIE_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "ERNIE_Career.csv", row.names = FALSE)
```
