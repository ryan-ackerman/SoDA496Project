...
Race <- read.csv("BERT_base_multi_cased_Race.csv")
Gender <- read.csv("BERT_base_multi_cased_Gender.csv")
Career <- read.csv("BERT_base_multi_cased_Career.csv")
...
for (i in seq_along(TukeyHSD_result_list)) {
  ...
  tidy_result$Model <- "BERT_base_multi_cased"
