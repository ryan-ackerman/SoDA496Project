...
write.csv(RaceWithinModel, "BERT_base_multi_uncased_Race.csv", row.names = FALSE)
...
write.csv(GenderWithinModel, "BERT_base_multi_uncased_Gender.csv", row.names = FALSE)
...
write.csv(STEMWithinModel, "BERT_base_multi_uncased_Career.csv", row.names = FALSE)
```
