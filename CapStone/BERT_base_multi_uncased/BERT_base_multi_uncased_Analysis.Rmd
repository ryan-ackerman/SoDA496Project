...
Race <- read.csv("BERT_base_multi_uncased_Race.csv")
Gender <- read.csv("BERT_base_multi_uncased_Gender.csv")
Career <- read.csv("BERT_base_multi_uncased_Career.csv")
...
for (i in seq_along(TukeyHSD_result_list)) {
  ...
  tidy_result$Model <- "BERT_base_multi_uncased"
